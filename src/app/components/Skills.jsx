...
const Skills = () => {
  ...
  const data = [
    ...
    { name: "Ruby/Rails", value: 35 },
    { name: "Python", value: 30 },
    { name: "Figma", value: 20 },
    { name: "Illustrator", value: 15 },
  ];
  return (
    <div className="flex flex-col relative mb-12 min-h-[90vh] bg-background-secondary" id="skills">
      <div className="flex flex-col items-center justify-center">
        <h3 className="my-projects-text text-4xl font-bold italic">
          My Skills
        </h3>
        <div className="flex flex-wrap items-center justify-center">
          {skillsData.map((skill, key) => {
            return (
              <motion.div
                key={key}
                className="w-32 bg-[#17181a] m-6 p-4 text-center text-[#fffc38] flex flex-col justify-center items-center skill-item"
